...
import { useSdk } from 'services/nft/client/wallet'
    ...
    return (
      <Grid templateColumns="repeat(10, 1fr)" gap={4}>
        ...
        <GridItem colSpan={8} textAlign="left">
          <chakra.p fontSize="xs">Balance</chakra.p>
          <chakra.p fontWeight="semibold">{formatPrice(props.coin)}</chakra.p>
        </GridItem>
      </Grid>
    )
  }
