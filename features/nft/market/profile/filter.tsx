    ...
    <FilterWrapper className={`filter-wrapper ${isCollapse ? 'collapse' : ''}`}>
      <header>
        <Button
          ...
          variant="ghost"
          iconRight={
            (!isCollapse && <IconWrapper icon={<ArrowLeft />} />) ||
            (isCollapse && <IconWrapper icon={<Sidebar />} />)
          }
          onClick={() => {
        ...
        <AccordionItem className="hide">
          ...
          <AccordionPanel pb={4}>
            <Conditions className="grid">
              <Button
                variant={`${
                  profile_status.indexOf(FILTER_STATUS_BUY_NOW) != -1
                    ? 'primary'
                    : 'secondary'
                }`}
                onClick={() => {
                  if (profile_status.indexOf(FILTER_STATUS_BUY_NOW) == -1) {
                    ...
                    profile_status.splice(
                      profile_status.indexOf(FILTER_STATUS_BUY_NOW),
                      1
                    )
                  }
              ...
              <Button
                variant={`${
                  profile_status.indexOf(FILTER_STATUS_ON_AUCTION) != -1
                    ? 'primary'
                    : 'secondary'
                }`}
                onClick={() => {
                  if (profile_status.indexOf(FILTER_STATUS_ON_AUCTION) == -1) {
                    ...
                    profile_status.splice(
                      profile_status.indexOf(FILTER_STATUS_ON_AUCTION),
                      1
                    )
                  }
                  //setFilterData(PROFILE_STATUS, profile_status)
              ...
              <Button
                variant={`${
                  profile_status.indexOf(FILTER_STATUS_NEW) != -1
                    ? 'primary'
                    : 'secondary'
                }`}
                onClick={() => {
                  if (profile_status.indexOf(FILTER_STATUS_NEW) == -1) {
                    ...
                    profile_status.splice(
                      profile_status.indexOf(FILTER_STATUS_NEW),
                      1
                    )
                  }
              ...
              <Button
                variant={`${
                  profile_status.indexOf(FILTER_STATUS_HAS_OFFERS) != -1
                    ? 'primary'
                    : 'secondary'
                }`}
                onClick={() => {
                  if (profile_status.indexOf(FILTER_STATUS_HAS_OFFERS) == -1) {
                    ...
                    profile_status.splice(
                      profile_status.indexOf(FILTER_STATUS_HAS_OFFERS),
                      1
                    )
                  }
                  //setProfileData(PROFILE_STATUS, profile_status)
            ...
            <Conditions className="grid">
              {FILTER_ACCESSORIES.map((item, index) => (
                <Button
                  ...
                  variant="secondary"
                  className={`${
                    profile_status.indexOf(item.id) != -1 ? 'active' : 'default'
                  }`}
                  onClick={() => {
