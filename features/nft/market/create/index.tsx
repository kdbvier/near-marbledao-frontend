...
export const CreateNFT = () => {
  ...
  const fetchCollections = async () => {
    try {
      ...
      alert('Please create your collection first')
      return []
    }
  }
  useEffect(() => {
  ...
  useEffect(() => {
    if (txHash && getCurrentWallet().wallet.isSignedIn()) {
      console.log('here: ', pathname, txHash, errorType)
  ...
  return (
    <Container>
      ...
      <ItemContainer className="collection-item">
        <h3>
          Image, Video, Audio, Or 3D model<span className="required">*</span>
        </h3>
        <p>
          File Types Supported: JPG, PNG, GIF, SVG, MP4, WEBM, MP3, WAV, OGG,
          GLB, GIFT. Max size: 100MB
        </p>
